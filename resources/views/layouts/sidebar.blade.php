        ...
        @can('manage-users')
            <div x-data="{ adminOpen: false }">
                ...
                <div x-show="adminOpen && open" x-transition:enter="transition ease-out duration-200"
                    ...
                    @can('delete-anc-visits')
                        <a href="{{ route('admin.deleted-visits') }}"
                            class="flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors text-sm {{ request()->routeIs('admin.deleted-visits') ? 'bg-green-600' : 'hover:bg-green-600/40' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg>
                            <span>Restore Data ANC</span>
                        </a>
                    @endcan
