...
<div class="space-y-6">
    ...
    <!-- Status Keluar, Service Fee & Payment -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <!-- Biaya Jasa Layanan (NEW) -->
        <div>
            <label for="service_fee" class="block text-sm font-medium text-gray-700 mb-1">
                💵 Biaya Jasa Layanan
            </label>
            <div class="relative">
                ...
                <input type="number" wire:model.live="service_fee" id="service_fee" min="0" step="1"
                    class="block w-full pl-10 shadow-sm sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                    placeholder="0">
            </div>
            <p class="mt-1 text-xs text-gray-500">Kosongkan jika gratis</p>
        </div>
    ...
    <div class="flex justify-between pt-4 border-t border-gray-200">
        ...
        <button wire:click="save" type="button" wire:loading.attr="disabled"
            class="inline-flex items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
