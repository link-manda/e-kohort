<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Export data master pasien ke format Excel atau CSV</p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row gap-3">
                ...
                <button wire:click="exportCsv" wire:loading.attr="disabled"
                    ...
                    <svg wire:loading.remove wire:target="exportCsv" class="w-5 h-5 mr-2" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <svg wire:loading wire:target="exportCsv" class="animate-spin h-5 w-5 mr-2" fill="none"
                        viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                            stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor"
                    ...
                    <span wire:loading.remove wire:target="exportCsv">Export ke CSV (.csv)</span>
