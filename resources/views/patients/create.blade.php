    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Isi data lengkap pasien untuk pendaftaran</p>
            </div>
            <a href="{{ route('patients.index') }}" class="text-gray-600 hover:text-gray-800 flex items-center space-x-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="blood_type" name="blood_type"
                                ...
                                <option value="Unknown" {{ old('blood_type') == 'Unknown' ? 'selected' : '' }}>Tidak
                                    Tahu</option>
                            </select>
                            @error('blood_type')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="text" id="no_kk" name="no_kk" value="{{ old('no_kk') }}"
                                maxlength="16" placeholder="16 digit (opsional)"
                        ...
                        <div>
                            ...
                            <input type="text" id="no_bpjs" name="no_bpjs" value="{{ old('no_bpjs') }}"
                                maxlength="13" placeholder="13 digit (opsional)"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="husband_name" name="husband_name"
                                value="{{ old('husband_name') }}" placeholder="Masukkan nama lengkap suami"
                        ...
                        <div>
                            ...
                            <input type="text" id="husband_nik" name="husband_nik"
                                value="{{ old('husband_nik') }}" maxlength="16" placeholder="16 digit (opsional)"
                        ...
                        <div>
                            ...
                            <input type="text" id="husband_job" name="husband_job"
                                value="{{ old('husband_job') }}" placeholder="Contoh: Petani, Wiraswasta, PNS"
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <ul class="text-sm text-blue-800 space-y-1">
                                ...
                                <li>• Data suami bersifat opsional</li>
                            </ul>
                        </div>
                    </div>
                </div>
